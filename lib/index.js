...
const Fuller = function(planFileName, taskName, args) {
...
Fuller.prototype.loadBelts = function() {
  const tasks = this.plan[this.taskName];
  this.belts = {};
  this.tasks = {};
...
Fuller.prototype.onPlan = function() {
  ...
  this.options = Object.assign({}, this.plan.options, this.args);
  ...
  this.verbose
    ...
    .log(chalk.bold.cyan('Fuller has got a new plan...'));
